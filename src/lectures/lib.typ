...
#let lecturevideo(lectitle,videolink) = context {
  if target() == "html" {
    html.elem("div", attrs: (class: "flex justify-center"))[
      #html.video(controls: true, src: videolink, playsinline: true)
    ]
    //html.elem("video", attrs: (src: videolink, class: "w-full"))[
    //  controls
    //]
